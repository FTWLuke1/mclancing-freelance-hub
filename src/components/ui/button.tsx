  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-foreground font-semibold shadow-glow hover:shadow-elegant hover:scale-105 transition-spring",
        "hero-outline": "border-2 border-secondary bg-transparent text-secondary font-semibold hover:bg-secondary hover:text-secondary-foreground transition-spring",
        premium: "bg-brand-purple text-foreground font-semibold shadow-lg hover:shadow-glow hover:scale-105 transition-spring",
      },
      size: {
